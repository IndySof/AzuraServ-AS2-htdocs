...
if(isset($_POST) && !empty($_POST)){
	if(isset($_POST["username"],$_POST["email"], $_POST["password"], $_POST["repassword"], $_POST["penguinColor"], $_POST["g-recaptcha-response"]) && !empty($_POST["username"]) && !empty($_POST["email"]) && !empty($_POST["password"]) && !empty($_POST["repassword"]) && !empty($_POST["penguinColor"]) && !empty($_POST["g-recaptcha-response"])){
            ...
            $strResponse = file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6Lc8Jp4UAAAAAI5Ny0Hw_JIdeQasrMUqUmflKLPR".$strSecretKey."&response=".$strCaptcha."&remoteip=".$intIP);
...
$('input').keyup(function(){
  ...
  <div class="form-group">
      ...
      <div style="margin-left: -160px;" class="g-recaptcha" data-sitekey="6Lc8Jp4UAAAAAPC9rXvmU3UMqcLaQg3CzdbkNpB_"></div><br>
...
function changeImage(imgName)
{
    ...
    <footer>
        <ul>
            <li><a href="https://github.com/indysof" target="_blank"><i class="fa fa-github-square"></i></a></li>
        </ul>
        <p>Theme by <a href="https://sbi-fox.com" target="_blank">IndySof</a>.</p>
        <p>&copy; 2019 AzuraCP.</p>
    </footer>  
	</body>
</html>